...
visualize the relationship of some NBA players' data. It includes radio buttons
to add a smoother (e.g. linear regression, loess).
...
runGitHub(
  repo = "shiny", 
  username = "data133", 
  subdir = "nba-scatterplots3-smoother1")
```
